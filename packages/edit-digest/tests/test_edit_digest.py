"""Tests for edit-digest, written against the ways this goes wrong."""
...
import pytest
from edit_digest import compute, load, normalize, render_prompt_block, render_report
from edit_digest.cli import main as cli_main
